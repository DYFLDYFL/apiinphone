...
export function worldSystemPrompt(worldview?: string): string {
  return [
    ...
    '5. 拨钟：{"nextTime":{"description":"...","year":1,"month":3,"day":2,"hour":14,"minute":20},"sceneSummary":"...","publicEvent":"..."}。',
    "6. nextTime 必须提供合法的 year/month/day/hour/minute 数字和简短 description；禁止用自由字符串、地支时辰或「第 N 时」代替。",
